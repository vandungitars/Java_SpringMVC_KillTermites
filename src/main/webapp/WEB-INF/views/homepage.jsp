...
<body>
				  ...
				  <div class="container-fluid">
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav navbar-center">
				        ...
				        <li class="active tab-menu" style="padding-top: 15px"><a href="/dietmoi/">TRANG CHU <span class="sr-only">(current)</span></a></li>
				        <li class="dropdown tab-menu">
				          ...
				          <ul class="dropdown-menu">				      
							     <li><a href="dichvu/1">Diệt mối nhà riêng</a></li>
							     <li><a href="dichvu/2">Diệt mối công trình</a></li>
							     <li><a href="dichvu/3">Diệt mối đình, chùa</a></li>
					      </ul>				      
				        </li>
				        <li class="dropdown tab-menu">
				          <a class="dropdown-toggle" data-toggle="dropdown" href="#">DỊCH VỤ DIỆT CÔN TRÙNG<span class="caret"></span></a>
				          <ul class="dropdown-menu">				      
							     <li><a href="dichvu/4">Phun muỗi</a></li>
							     <li><a href="dichvu/5">Diệt gián</a></li>
					      </ul>				      
				        </li>
				        <li class="tab-menu"><a href="thuocdiet/">SẢN PHẨM THUỐC</a></li>
				        <li class="tab-menu"><a href="lienhe/">LIEN HE</a></li>
	...
	<div id="body-homepage" class="row container-fluid">
		...
		<div class="col-md-8 partitioning-frame" id="bodyNews">
			<h3>${listNews[0].getTitle()}</h3>
			<img style="width: 100%; height: 400px" src="<c:url value="/resources/Image/${listNews[0].getImage()}"/>"></br></br>
			<p>${listNews[0].getContent()}</p>
		</div>
		<div class="col-md-2 partitioning-frame">
                    ...
                    <tbody>
                    	<c:forEach items="${listProducts}" var="product">
						    <tr>
	                            ...
	                            <td><a href="lienhe/" class="btn btn-danger" id="" style="color: white; margin-top: 10px">MUA</a></td>	                            
	                      	</tr>
						</c:forEach>
                    </tbody>
            </table>
	...
	<div id="footer-homepage" class="row container-fluid">
		<div class="row">
