	...
	<div id="body-homepage" class="row container-fluid">
		...
		<div class="col-md-10">
			<c:forEach items="${listProducts}" var="product">
				<div class="col-md-3 col-sm-4 wow rollIn">
					<a href="/dietmoi/lienhe/">
						<div class="product-card">
							<img style="width: 250px; height: 300px" src="<c:url value="/resources/Image/${product.getImage()}"/>" alt="thuốc diệt côn trùng">
							<span class="details-product">${ product.getNameproduct()}</span><br/>
							<span class="details-product">${product.getPrice()}</span><br/>
						</div>
					</a>
			    </div>
			</c:forEach>
